 ...
 * @project  jcseg
 * @href https://code.google.com/p/jcseg/
 */
public class JcsegTest {
	...
	public JcsegTest() throws JcsegException, IOException {
		...
		String configPath="C:/Users/Tassadar/eclipse/CodeBigBro/conf/jcseg.properties";
		JcsegTaskConfig config = new JcsegTaskConfig(configPath);
